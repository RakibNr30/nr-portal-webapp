                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-gray-dark card-outline">
                        <div class="card-header">
                            <h3 class="card-title mt-1">Create ImportantPerson</h3>
                        ...
                        {!! Form::open(['url' => route('backend.cms.important-person.store'), 'method' => 'important-person', 'files' => true]) !!}
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
									...
									<div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input id="company" name="company" value="{{ old('company') }}" type="text" class="form-control @error('company') is-invalid @enderror" placeholder="Enter company" autofocus>
                                            @error('company')
                                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                            @enderror
                                        </div>
									...
									<div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input id="external_link" name="external_link" value="{{ old('external_link') }}" type="text" class="form-control @error('external_link') is-invalid @enderror" placeholder="Enter external_link" autofocus>
                                            @error('external_link')
                                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                            @enderror
                                        </div>
