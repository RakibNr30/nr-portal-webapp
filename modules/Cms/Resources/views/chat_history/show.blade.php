    ...
    <div class="page-content">
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="page-title mb-0 font-size-18">{{ __('admin/chat_history/show.chat') }}</h4>
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">{{ __('admin/chat_history/show.chat') }}</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('backend.cms.chat-history.index') }}">{{ __('admin/chat_history/show.history') }}</a></li>
                            <li class="breadcrumb-item active">{{ __('admin/chat_history/show.view') }}</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title mb-4">{{ __('admin/chat_history/show.chat_history') }}</h4>
