                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="name" name="name" value="{{ $userLanguage->name ?: 'N/A'}}" type="text" class="form-control-plaintext" readonly>
                                        @error('name')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="description" name="description" value="{{ $userLanguage->description ?: 'N/A'}}" type="text" class="form-control-plaintext" readonly>
                                        @error('description')
                                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="proficiency" name="proficiency" value="{{ $userLanguage->proficiency ?: 'N/A'}}" type="text" class="form-control-plaintext" readonly>
                                        @error('proficiency')
                                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                        @enderror
                                    </div>
									...
									<div class="col-md-12">
                                    <div class="form-group">
                                        <label for="user_id" class="@error('user_id') text-danger @enderror">UserId</label>
                                        <input id="user_id" name="user_id" value="{{ $userLanguage->user_id ?: 'N/A'}}" type="text" class="form-control-plaintext" readonly>
                                        @error('user_id')
                                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                        @enderror
                                    </div>
