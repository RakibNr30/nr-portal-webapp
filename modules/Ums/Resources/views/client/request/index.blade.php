...
@section('title')
    {{ __('admin/client_request/index.request') }} | {{ __('admin/client_request/index.client') }}
@stop
@section('content')
    <div class="page-content">
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="page-title mb-0 font-size-18">{{ __('admin/client_request/index.client') }}</h4>
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">{{ __('admin/client_request/index.client') }}</a></li>
                            <li class="breadcrumb-item active">{{ __('admin/client_request/index.request') }}</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title mb-4">{{ __('admin/client_request/index.client_request_list') }}</h4>
