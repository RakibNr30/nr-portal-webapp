                    ...
                    <div class="card card-gray-dark card-outline">
                        <div class="card-header">
                            ...
                            <a href="{{ route('backend.ums.profile-interest.index') }}" type="button"
                               class="btn btn-success btn-sm text-white float-right">View User Interest List</a>
                        </div>
                        {!! Form::open(['url' => route('backend.ums.profile-interest.store'), 'method' => 'user-interest', 'files' => true]) !!}
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
