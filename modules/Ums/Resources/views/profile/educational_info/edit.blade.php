            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <div class="card card-gray-dark card-outline">
                        ...
                        {!! Form::open(['url' => route('backend.ums.profile-educational-info.update', [$userEducationalInfo->id]), 'method' => 'put', 'files' => true]) !!}
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="institute_name" name="institute_name"
                                               value="{{ old('institute_name') ?: $userEducationalInfo->institute_name }}"
                                               type="text"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="course_name" name="course_name"
                                               value="{{ old('course_name') ?: $userEducationalInfo->course_name }}"
                                               type="text"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="degree_name" name="degree_name"
                                               value="{{ old('degree_name') ?: $userEducationalInfo->degree_name }}"
                                               type="text"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="start_date" name="start_date"
                                               value="{{ old('start_date') ?: $userEducationalInfo->start_date }}"
                                               type="text"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="end_date" name="end_date"
                                               value="{{ old('end_date') ?: $userEducationalInfo->end_date }}"
                                               type="text" class="form-control datepicker @error('end_date') is-invalid @enderror"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="description" name="description" class="form-control" rows="3"
                                                  placeholder="Enter description">{{ old('description') ?: $userEducationalInfo->description }}</textarea>
                                        @error('description')
                                        <span class="invalid-feedback"
                                              role="alert"><strong>{{ $message }}</strong></span>
                                        @enderror
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="institute_website" name="institute_website"
                                               value="{{ old('institute_website') ?: $userEducationalInfo->institute_website }}"
                                               type="text"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="institute_email" name="institute_email"
                                               value="{{ old('institute_email') ?: $userEducationalInfo->institute_email }}"
                                               type="email"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="institute_phone" name="institute_phone"
                                               value="{{ old('institute_phone') ?: $userEducationalInfo->institute_phone }}"
                                               type="text"
