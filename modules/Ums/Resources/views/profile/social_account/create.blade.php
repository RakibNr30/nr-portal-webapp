                    ...
                    <div class="card card-gray-dark card-outline">
                        <div class="card-header">
                            ...
                            <a href="{{ route('backend.ums.profile-social-account.index') }}" type="button"
                               class="btn btn-success btn-sm text-white float-right">View UserSocialAccount List</a>
                        </div>
                        {!! Form::open(['url' => route('backend.ums.profile-social-account.store'), 'method' => 'user-social-account', 'files' => true]) !!}
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select id="social_site_id" name="social_site_id"
                                            ...
                                            @foreach($socialSites as $socialSite)
                                                <option value="{{ $socialSite->id }}">{{ \Illuminate\Support\Str::title($socialSite->title) }}</option>
                                            @endforeach
                                        </select>
