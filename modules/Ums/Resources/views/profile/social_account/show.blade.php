                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="username" name="username"
                                               value="{{ $userSocialAccount->username ?: 'N/A'}}" type="text"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="social_site_id"
                                               class="@error('social_site_id') text-danger @enderror">Social Site
                                            Id</label>
                                        <input id="social_site_id" name="social_site_id"
                                               value="{{ $userSocialAccount->social_site_id ?: 'N/A'}}" type="text"
                                               class="form-control-plaintext" readonly>
