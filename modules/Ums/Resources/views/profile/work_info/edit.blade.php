            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <div class="card card-gray-dark card-outline">
                        ...
                        {!! Form::open(['url' => route('backend.ums.profile-work-info.update', [$userWorkInfo->id]), 'method' => 'put', 'files' => true]) !!}
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="company_name" name="company_name"
                                               value="{{ old('company_name') ?: $userWorkInfo->company_name }}"
                                               type="text"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="company_website" name="company_website"
                                               value="{{ old('company_website') ?: $userWorkInfo->company_website }}"
                                               type="text"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="company_address" name="company_address"
                                               value="{{ old('company_address') ?: $userWorkInfo->company_address }}"
                                               type="text"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="department" name="department"
                                               value="{{ old('department') ?: $userWorkInfo->department }}" type="text"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="designation" name="designation"
                                               value="{{ old('designation') ?: $userWorkInfo->designation }}"
                                               type="text"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="start_date" name="start_date"
                                               value="{{ old('start_date') ?: $userWorkInfo->start_date }}" type="text"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="end_date" name="end_date"
                                               value="{{ old('end_date') ?: $userWorkInfo->end_date }}" type="text"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="description" name="description" class="form-control" rows="3"
                                                  placeholder="Enter description">{{ old('description') ?: $userWorkInfo->description }}</textarea>
                                        @error('description')
                                        <span class="invalid-feedback"
                                              role="alert"><strong>{{ $message }}</strong></span>
                                        @enderror
