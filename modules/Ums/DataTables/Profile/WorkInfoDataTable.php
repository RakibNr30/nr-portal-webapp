...
class WorkInfoDataTable extends DataTable
{
    ...
    public function query(UserWorkInfo $model)
    {
        ...
        // other condition
        $user_work_info->where('user_work_infos.user_id', auth()->user()->id);
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('name')->name('user_personal_infos.last_name')->hidden()->hidden(), // alias used
            Column::make('company_name'),
            Column::make('department')->hidden(),
            Column::make('designation')->hidden(),
