...
return [
    ...
    'admin_menu' => [
        ...
        [
            ...
            "name_dt" => "Geaccepteerde<br><span style='margin-left: 33px'>aanvragen</span>",
            "name_client" => "Accepted Projects",
            "name_client_dt" => "Geaccepteerde<br><span style='margin-left: 33px'>aanvragen</span>",
            "name_company" => "In Progress Projects",
            "name_company_dt" => "In offertefase",
            "name_admin" => "Accepted Projects",
            "name_admin_dt" => "Geaccepteerde<br><span style='margin-left: 33px'>aanvragen</span>",
            "name_super_admin" => "Accepted Projects",
            "name_super_admin_dt" => "Geaccepteerde<br><span style='margin-left: 33px'>aanvragen</span>",
            "id" => "project",
            "icon" => "fa-check-circle",
