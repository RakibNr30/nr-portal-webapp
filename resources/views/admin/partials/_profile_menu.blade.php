<div class="card card-gray-dark card-outline">
    <div class="card-body box-profile">
        ...
        <h3 class="profile-username text-center">{{ $user->basicInfo->first_name }} {{ $user->basicInfo->last_name }}</h3>
        <p class="text-muted text-center">{{ $user->basicInfo->designation }}</p>
